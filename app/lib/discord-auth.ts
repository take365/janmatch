...
type Config = { clientId?: string; clientSecret?: string; guildId?: string; appOrigin?: string; applicationId?: string; publicKey?: string; botToken?: string; operatorRoleId?: string; operatorChannelId?: string; allowedChannelIds?: string[] };
