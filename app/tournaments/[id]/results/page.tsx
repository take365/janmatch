...
type Participant = { userId: string; nickname: string; gameName: string; rank: number; rounds: RoundResult[]; totalRaw: number; totalWithUma: number };
