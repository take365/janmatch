...
export default function TournamentPage() {
  ...
  const load = async () => {
    ...
    const auth = authResponse.ok ? await authResponse.json() as { user?: { id?: string } } : {};
    ...
    const entriesResponse = currentUserId ? await fetch(`/api/tournaments/entries?tournamentId=${encodeURIComponent(id)}`) : null;
