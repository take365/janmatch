...
type Tournament = { id: string; name: string; gameType?: string; date: string; rounds: number; status: string; color: string; pairingMode?: string; phase?: Phase };
const initialTournaments: Tournament[] = [
  { id: "janmatch-01", name: "第1回 JanMatch交流戦", gameType: "雀魂-じゃんたま-", date: "2026年10月12日（月）20:00開始", rounds: 4, status: "開催前", color: "green", pairingMode: "最終戦だけ順位卓", phase: "before" },
  { id: "janmatch-test", name: "JanMatchテスト大会", gameType: "雀魂-じゃんたま-", date: "2026年9月16日（水）開催中", rounds: 3, status: "開催中", color: "blue", pairingMode: "重複回避ランダム", phase: "active" },
  { id: "janmatch-finished", name: "JanMatchサンプル大会", gameType: "雀魂-じゃんたま-", date: "2026年9月1日（火）終了", rounds: 4, status: "終了", color: "gray", pairingMode: "2回戦目以降すべて順位卓", phase: "ended" },
];
